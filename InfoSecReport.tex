...
\author{Fadwa~Bin~Ishaq,~Yanan~Xiao,~\IEEEmembership{Student~Member,~IEEE}
Maryam~Al~Mehrezi%
\IEEEcompsocitemizethanks{\IEEEcompsocthanksitem Fadwa Bin Ishaq,
Yanan Xiao and Maryam Al Mehrezi are with the Department of Electrical Engineering and
...
\begin{abstract}
%\boldmath
In this paper we discuss the RSA and El-Gamal cryptosystem. Alongside we introduce our
way of implementing them in Python and C.
\end{abstract}
...
\par
This is just another testing text. To test \cite{ref:Pholig1978}.
Yet another El-Gamal \cite{ref:Elgamal1985,ref:Elgamal1985A}.
