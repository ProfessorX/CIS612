...
$\alpha$.
\par
In chapter 3 of ``Handbook of Applied Cryptography'', the authors
point out that ``Solving the DLP in a cyclic group $G$ of order $n$ is
in essence computing an isomorphism between $G$ and
