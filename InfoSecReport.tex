...
construction.
\par
Running time. Let's assume that $\log n$ times comparison is much less
...
\end{equation}
With equation~\autoref{eq:pollard-4} at hand, it would be easy to work
out $\log_{\alpha}\beta$. 
\begin{figure}[!t]
  \centering
  \begin{algorithmic}
    ...
    \item For $i=1,2,\ldots$ do
      ...
      \item Calculate $x_{i}$, $a_{i}$, $b_{i}$ and $x_{2i}$,
        ...
        equations~\autoref{eq:pollard-1},\autoref{eq:pollard-2} and
